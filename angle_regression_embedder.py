...
input_source = "videos/straight_waving.avi"
# input_source = 0
...
while 1:
    ...
    try:
        ...
        print("Improper points received")
        continue

    embeddings_angles.append([embed, angle])
    done_frames += 1
    #print(points)
    #Draw Skeleton
...
#print(embeddings_angles)
pickle.dump(embeddings_angles, open("embeddings/embeddings_and_angles.pkl", 'wb'))
vid_writer.release()
cap.release()
